...
void AudioAnalyser::init(std::string musicFilePath, int _numBinsPerAverage)
{
	m_pSoundPlayer.load(musicFilePath);
...
void AudioAnalyser::update()
{
	...
	//m_waveformLeft = ofFmodSoundGetSpectrumCustom(m_waveformNumSamples, 0);
	//m_waveformRight = ofFmodSoundGetSpectrumCustom(m_waveformNumSamples, 1);

	//m_waveformLeft = ofSoundGetSpectrum(m_waveformNumSamples);
	//m_waveformRight = ofSoundGetSpectrum(m_waveformNumSamples);

	m_waveformLeft	= ofFmodSoundGetWaveData_MOD(m_waveformNumSamples, 0);
	m_waveformRight = ofFmodSoundGetWaveData_MOD(m_waveformNumSamples, 1);
